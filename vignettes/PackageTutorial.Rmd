...
**Step 3** The following codes are the functions included in my package, with first a data clean function where we create a new CSV file:
...
**Step 4** Now that we have assigned an object with our new clean dataframe, we can run the following functions using the object for the clean dataset:
...
**BONUS:** If you have any questions, you will not find the answer at kylepiller.com, however you may be interested in clicking the link anyway. [http://www.kylepiller.com/](kylepiller.com)
