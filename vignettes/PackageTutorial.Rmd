...
### This package will be used to remove na's, create a sampling location map, scatter plot, and a linear model of a water quality data
...
The following codes are the functions included in my package, with first a data clean function where we create a new CSV file:
...
Now that we have assigned an object with our new clean dataframe, we can run the following functions using the object for the clean dataset:
